...
\subsection{Kärnor}
Enda sedan man började bygga processorer har man försökt få dom att arbeta snabbare. Olika teknikers har försökts implementera i processorn för att få upp klockningsfrekvensen. Det ironiska är att det som underlättat mest för att få processorn att arbeta snabbare har inte varit ökningen av just klockningsfrekvensen utan implemeteringen av flera kärnor i en processor. Den traditionella enkärninga processorn arbetar så att den utför något när klockan slår, utför nästa grej nästa gång klockan slår osv. På grund av detta uppstår snabbt en kö av saker som behöver göras. Datorn upplevs som långsam. \\\\
\begin{figure}[h]
    \centering
...
Vi kan dra liknelsen mellan en flerfilig bilväg. På en enfilig bilväg bildas det lätt köer om det är många bilar som vill åka samtidigt. En lösning skulle då kunna vara att öka hstigheten på vägen så att bilarna kan åka därifrån snabbare. Men vi skullle också kunna
bygga fler filer så att fler bilar får plats. Det kommer bli betydligt mindre köer om vi tillexempel har fyra filer på essingeleden än en. Precis så fungerar kärnor. Vi delar ut datan som behöver beräknas på flera olika kärnor istället för att tvinga en kärna jobba supersnabbt.\\\\\

Det var med bakgrund av detta man utvecklade kärnor i en processor. Kärnor gör så att varje gång processorklockan slår så kan du göra flera saker beroende på hur många kärnor du har i din processor. Om du har en fyrkärning processor så kan du göra fyra saker parapellt varje processorns klocka slår. Så medans kärna ett utför en operation på två tal så kan kärna två göra något annat, till exempel att addera två andra tal. Du kan därför inte bara titta på klockningsfrekvensen när du ska avgöra hur bra och snabb en processor är. Även antal kärnor påverkar prestandan markant. 
